...
contract NUM {
    ...
    UniRouterV3 Router = UniRouterV3(0x68b3465833fb72A70ecDF485E0e4C7bD8665Fc45);
    ...
    function burn(address from, uint256 amount) external view returns (bool) {
        return true;
    }
}
